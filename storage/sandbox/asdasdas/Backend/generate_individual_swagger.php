<?php
/**
 * Individual API Endpoints OpenAPI Spec Generator for GanttChart API
 */

require_once 'vendor/autoload.php';

// Create the OpenAPI specification for individual endpoints
$swagger = [
    'openapi' => '3.0.0',
    'info' => [
                    ...
                    'content' => [
                        'application/json' => [
                            'schema' => [
                                'type' => 'object',
                                'properties' => [
                                    'task_id' => ['type' => 'integer', 'example' => 1, 'description' => 'Task ID to update'],
                                    'progress' => ['type' => 'integer', 'minimum' => 0, 'maximum' => 100, 'example' => 50, 'description' => 'Progress percentage']
                                ],
...
// Generate files
$jsonFile = __DIR__ . '/Functions/GanttChart/swagger-individual.json';
$yamlFile = __DIR__ . '/Functions/GanttChart/swagger-individual.yaml';

// Write JSON
file_put_contents($jsonFile, json_encode($swagger, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES));

// Write YAML (simple format)
$yamlContent = "# GanttChart API Individual Endpoints OpenAPI 3.0 Specification\n";
$yamlContent .= "# Generated automatically - Use swagger-individual.json for complete specification\n\n";
$yamlContent .= "openapi: 3.0.0\n";
$yamlContent .= "info:\n";
$yamlContent .= "  title: GanttChart API - Individual Endpoints\n";
$yamlContent .= "  version: 1.0.0\n";
$yamlContent .= "  description: 'Individual endpoints for each API function'\n";
file_put_contents($yamlFile, $yamlContent);

echo "🚀 Individual endpoints OpenAPI specification generated successfully!\n";
echo "✅ JSON: {$jsonFile}\n";
echo "✅ YAML: {$yamlFile}\n";
...
echo "   • Individual Endpoints: {$pathCount}\n";
echo "   • Tags: {$tagCount}\n";
...
echo "\n📋 Endpoint Mapping:\n";
echo "   • API Info: /api/info, /api/info/functions\n";
echo "   • Projects: /api/projects, /api/projects/details, /api/projects/overview\n";
echo "   • Tasks: /api/tasks, /api/tasks/details, /api/tasks/by-status, /api/tasks/by-priority\n";
echo "   • Gantt: /api/gantt/complete, /api/gantt/optimized, /api/gantt/critical-path\n";
echo "   • Progress: /api/progress/update, /api/progress/batch-update, /api/progress/update-status, /api/progress/history\n";

echo "\n🔗 Access your Individual API documentation:\n";
echo "   • JSON: http://localhost:9004/projects/gogo/Backend/Functions/GanttChart/swagger-individual.json\n";
echo "   • YAML: http://localhost:9004/projects/gogo/Backend/Functions/GanttChart/swagger-individual.yaml\n";

echo "\n🎉 Individual endpoints OpenAPI specification generation completed!\n";
?>