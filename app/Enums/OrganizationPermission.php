...
enum OrganizationPermission: int
{
    ...
    public function getLabel(): string
    {
        return match($this) {
            ...
            self::ORGANIZATION_ADMIN => '조직 목록자',
            self::ORGANIZATION_ADMIN_SENIOR => '선임 조직 목록자',
    ...
    public function getDescription(): string
    {
        return match($this) {
            ...
            self::ORGANIZATION_ADMIN => '조직 목록 권한, 멤버 관리 및 조직 설정',
            self::ORGANIZATION_ADMIN_SENIOR => '선임 조직 목록자, 고급 조직 목록 권한',
            self::ORGANIZATION_OWNER => '조직 소유자, 모든 조직 목록 권한',
    ...
    public function getLevelName(): string
    {
        return match($this) {
            ...
            self::ORGANIZATION_ADMIN, self::ORGANIZATION_ADMIN_SENIOR => '조직 목록자',
