    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">{{ $organization->description ?? '조직 설명이 없습니다.' }}</p>
            </div>
            <div class="text-right">
                <p class="text-sm text-gray-500">조직 ID</p>
                <p class="text-lg font-medium text-gray-900">#{{ $organization->id }}</p>
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">조직 프로젝트</p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">조직 페이지</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">조직 프로젝트</h3>
                <p class="text-sm text-gray-500">이 조직의 프로젝트 목록</p>
            </div>
            <div class="divide-y divide-gray-200 max-h-96 overflow-y-auto">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center mt-2 space-x-4">
                                    @if(isset($project['user']))
                                        <span class="text-xs text-gray-500">작성자: {{ $project['user']['name'] ?? '사용자 없음' }}</span>
                                    @endif
                                    <span class="text-xs text-blue-600">ID: {{ $project['id'] }}</span>
                                </div>
                            </div>
                ...
                @empty
                    <div class="px-6 py-8 text-center">
                        <p class="text-gray-500">이 조직에 프로젝트가 없습니다.</p>
                    </div>
                @endforelse
            </div>
        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <div class="flex items-center mt-2 space-x-4">
                                    ...
                                    @endif
                                    @if(isset($page['user']))
                                        <span class="text-xs text-gray-500">{{ $page['user']['name'] ?? '사용자 없음' }}</span>
                                    @endif
