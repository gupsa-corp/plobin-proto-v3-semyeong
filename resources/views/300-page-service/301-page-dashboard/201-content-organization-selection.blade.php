...
<div id="organizationSelectionScreen" style="display: none;">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <button id="createOrganizationBtn" @click="showCreateOrganizationModal()" class="flex items-center justify-center gap-1 px-4 py-2 bg-teal-500 hover:bg-teal-600 text-white font-bold text-sm rounded-full h-10">
