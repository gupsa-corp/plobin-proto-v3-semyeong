...
@include('300-page-service.300-common.301-layout-head', ['title' => '프로젝트 설정 - 권한 관리'])
<body class="bg-gray-100">
    <div class="min-h-screen" style="position: relative;">
        ...
        <div class="main-content" style="margin-left: 240px; min-height: 100vh;">
            ...
            @include('300-page-service.316-page-project-settings-permissions.200-content-main')
        </div>
    </div>
