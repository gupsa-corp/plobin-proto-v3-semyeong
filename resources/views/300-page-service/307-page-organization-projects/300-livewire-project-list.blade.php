{{-- 프로젝트 목록 Livewire 컴포넌트 --}}
<div class="projects-list-content" style="padding: 24px;">
    {{-- 헤더 --}}
    <div class="flex justify-between items-center mb-8">
        <div class="flex-1">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">프로젝트 관리</h1>
            <p class="text-lg text-gray-500">{{ $organization ? $organization->name : '조직' }}의 프로젝트를 관리하고 새로운 프로젝트를 생성할 수 있습니다.</p>
        </div>
    ...
    @elseif(count($projects) === 0)
        ...
        <div class="flex justify-center py-12">
            <div class="flex flex-col items-center justify-center">
                ...
                <p class="text-gray-500 mb-4">새로운 프로젝트를 생성해서 시작해보세요.</p>
    ...
    @else
        ...
        <div class="grid grid-cols-4 gap-6">
            @foreach($projects as $project)
                <a href="/organizations/{{ $project->organization_id }}/projects/{{ $project->id }}" class="block bg-white border border-gray-200 rounded-lg p-5 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                    {{-- 카드 헤더 --}}
                    <div class="flex justify-between items-start mb-4">
                        {{-- 프로젝트 아바타 --}}
                        <div class="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center">
                            <span class="text-white font-bold text-xl">
                                {{ $project->name ? mb_substr($project->name, 0, 1) : 'P' }}
                            </span>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center text-gray-600">
                            ...
                            <span class="text-base">{{ $project->description ?? '설명 없음' }}</span>
                        </div>
                    </div>
                </a>
            @endforeach
