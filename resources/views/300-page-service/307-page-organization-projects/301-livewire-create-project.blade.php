        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" wire:click="closeModal">
            <div class="bg-white rounded-2xl shadow-2xl p-20 w-[614px] h-[468px] flex flex-col justify-center items-start gap-5" wire:click.stop>
                ...
                <div class="flex flex-col items-center gap-3 w-full">
                    <h2 class="text-2xl font-bold text-gray-900 text-center w-full">새로운 프로젝트를 생성합니다</h2>
                </div>
                ...
                <!-- 에러 메시지 -->
                @if (session('error'))
                    <div class="w-full bg-red-50 border border-red-200 rounded-lg p-4">
                        <div class="flex">
                            <div class="flex-shrink-0">
                ...
                <!-- 폼 -->
                <form wire:submit.prevent="create" class="flex flex-col items-center gap-5 w-full">
                    <div class="flex flex-col items-center gap-4 w-full">
                        <div class="flex flex-col items-start gap-2 w-full">
                            <!-- 프로젝트 이름 입력 -->
                            <div class="flex flex-col justify-center items-start gap-1 w-full">
                                <div class="flex items-center pl-1 gap-2">
                                    <label for="projectName" class="text-sm text-gray-900">프로젝트 이름</label>
                                </div>
                                <input type="text"
                                       id="projectName"
                                       wire:model="name"
                                       placeholder="국영문 대소문자 2~255자"
                            ...
                            <div class="flex flex-col justify-center items-start gap-1 w-full mt-2">
                                <div class="flex items-center pl-1 gap-2">
                                    <label for="projectDescription" class="text-sm text-gray-900">프로젝트 설명 (선택사항)</label>
                                </div>
                        ...
                        <button type="submit"
                            ...
                            <span wire:loading.remove wire:target="create">생성하기</span>
                            <span wire:loading wire:target="create">생성 중...</span>
                        </button>
                    </div>
                </form>
