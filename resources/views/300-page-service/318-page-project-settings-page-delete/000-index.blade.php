...
@include('300-page-service.300-common.301-layout-head', ['title' => '프로젝트 설정 - 페이지 삭제'])
<body class="bg-gray-100">
    <div class="min-h-screen" style="position: relative;">
        ...
        <div class="main-content" style="margin-left: 240px; min-height: 100vh;">
            ...
            @include('300-page-service.318-page-project-settings-page-delete.200-content-main')
        </div>
    </div>
