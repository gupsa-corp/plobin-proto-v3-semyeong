...
class OrganizationManager {
    ...
    selectOrganization(orgId) {
        ...
        // 로컬 스토리지에 선택된 조직 정보 저장
        localStorage.setItem('selected_organization', JSON.stringify(selectedOrg));
        localStorage.setItem('selected_organization_id', orgId.toString());
