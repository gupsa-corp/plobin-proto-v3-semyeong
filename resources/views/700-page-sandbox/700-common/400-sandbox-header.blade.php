    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="pb-4">
            ...
            <div class="mb-3">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="/sandbox/file-list" class="inline-flex items-center px-3 py-1 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors">
                        파일 목록
                    </a>
