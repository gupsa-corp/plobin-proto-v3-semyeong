...
@include($common . '.301-layout-head', ['title' => '실시간 대시보드 - 샌드박스'])
...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen sandbox-container">
        <div class="sandbox-card">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-900 font-medium">실시간 대시보드</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-blue-900">실시간 대시보드</h1>
                            <p class="text-blue-700 text-sm">샌드박스 데이터베이스와 연동된 실시간 대시보드입니다.</p>
                        </div>
                    </div>
            ...
            <!-- Livewire 컴포넌트 -->
            @livewire('sandbox.custom-screens.live.dashboard-component')
        </div>
    </div>
